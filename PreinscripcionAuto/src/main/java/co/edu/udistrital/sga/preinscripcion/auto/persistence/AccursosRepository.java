...
public interface AccursosRepository extends JpaRepository<Accurso, Long> {
	 ...
	 @Query("select NEW co.edu.udistrital.sga.preinscripcion.auto.domain.AsignaturaGrupo(cu.curId, cu.curAsiCod, cu.curNroCupo, cu.curNroIns, cu.curCapMax, cu.curDepCod, cu.curGrupo) FROM Accurso cu where cu.curCraCod=:codigoProyecto and cu.curApeAno=:anio and cu.curApePer=:periodo")
