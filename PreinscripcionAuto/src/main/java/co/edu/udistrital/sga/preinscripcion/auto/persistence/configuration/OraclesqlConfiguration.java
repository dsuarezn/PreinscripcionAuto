package co.edu.udistrital.sga.preinscripcion.auto.persistence.configuration;
...
@EnableJpaRepositories(
		entityManagerFactoryRef = "oracleqlEntityManager", 
		transactionManagerRef = "oraclesqlTransactionManager", 
		basePackages = "co.edu.udistrital.sga.preinscripcion.auto.persistence.entities.oracle"
)
public class OraclesqlConfiguration {
	...
	public PlatformTransactionManager postgresqlTransactionManager(@Qualifier("oracleqlEntityManager") EntityManagerFactory entityManagerFactory) {
