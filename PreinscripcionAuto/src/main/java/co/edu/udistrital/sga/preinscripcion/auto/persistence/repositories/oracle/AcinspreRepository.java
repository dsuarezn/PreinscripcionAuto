...
public interface AcinspreRepository extends JpaRepository<Acinspre, AcinsprePK> {
	...
	public List<AsignaturaRequerida> obtenerListaAsignaturasPreinsPre(@Param("anio") Integer anio, @Param("periodo") Integer periodo, @Param("codigoCarrera") Long codigoCarrera,@Param("estado")String estado);
