...
@EnableJpaRepositories(
		...
		basePackages = "co.edu.udistrital.sga.preinscripcion.auto.persistence.entities.mysql"
)
public class MysqlConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean mysqlEntityManagerFactory(EntityManagerFactoryBuilder builder) {
		return builder
					...
					.packages(SgaClasificacionEstudiante.class,SgaEjecutaInscripcionAuto.class,SgaRankingpreinsdemanda.class)
